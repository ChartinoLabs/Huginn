...
# Reporting
report_format = "html"             # Report format: html, json, junit
...
| `reports_dir`    | string | `"reports"`    | Directory for generated reports       |
...
| Setting                  | Type   | Default  | Description                                    |
| ------------------------ | ------ | -------- | ---------------------------------------------- |
| `report_format`          | string | `"html"` | Primary report format: `html`, `json`, `junit` |
...
Multiple report formats can be generated by specifying a list:

```toml
report_format = ["html", "junit"]  # Generate both HTML and JUnit XML
```
